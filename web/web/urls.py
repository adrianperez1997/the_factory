...
from myApp.views import new_machine, test, group_run, machine_delete, machine_test, machine, machine_edit, home, setup, machine_new_key, machine_new, machine_view_key, new_group
